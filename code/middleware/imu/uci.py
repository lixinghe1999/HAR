...
target_sr = 20
seq_len = 20
DATASET_PATH = "/home/lixing/har/dataset/uci/RawData"
path_save = "/home/lixing/har/dataset/uci"
version = r"{}_{}".format(target_sr, seq_len)
data, label = preprocess(DATASET_PATH, path_save, version, target_sr=target_sr, seq_len=seq_len)